...
export default function FbQuizPage({
  ...
  function goToSales() {
    ...
    if (typeof window !== "undefined") {
      window.clarity?.("event", "fb_quiz_step_5_completed");
    }
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col">
      ...
      {/* STEP CONTENT — flex column + justify-center with asymmetric padding
          (pt < pb) shifts content slightly upward so it doesn't leave a
          giant empty gap between the logo and the headline. */}
